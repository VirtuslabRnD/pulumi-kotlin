...
```kt
implementation("org.virtuslab:pulumi-azure-kotlin:5.80.0.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/azure/5.80.0.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>azure-native</td>
    <td>1.104.0.2</td>
