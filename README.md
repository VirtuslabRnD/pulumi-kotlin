...
```kt
implementation("org.virtuslab:pulumi-azure-kotlin:5.64.0.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/azure/5.64.0.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>azure-native</td>
    <td>1.104.0.1</td>
