...
```kt
implementation("org.virtuslab:pulumi-aws-kotlin:6.41.0.0")
```
 
 </td>
    <td><a href="https://search.maven.org/artifact/org.virtuslab/pulumi-aws-kotlin">link</a></td>
    <td><a href="https://www.pulumi.com/registry/packages/aws">link</a></td>
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/aws/6.41.0.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>aws-native</td>
    <td>0.108.4.0</td>
...
```kt
implementation("org.virtuslab:pulumi-aws-native-kotlin:0.108.4.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/aws-native/0.108.4.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>azure</td>
    <td>5.80.0.0</td>
