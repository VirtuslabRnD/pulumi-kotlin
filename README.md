...
```kt
implementation("org.virtuslab:pulumi-aws-native-kotlin:0.117.1.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/aws-native/0.117.1.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>azure</td>
    <td>5.87.0.0</td>
