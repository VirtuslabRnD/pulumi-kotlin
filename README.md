...
```kt
implementation("org.virtuslab:pulumi-aws-native-kotlin:0.85.0.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/aws-native/0.85.0.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>azure</td>
    <td>5.55.0.0</td>
