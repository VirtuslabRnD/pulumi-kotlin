...
internal class CustomResourceOptionsTest {
    ...
    @Test
    fun `option additionalSecretOutputs should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `option aliases should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `option customTimeouts should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `option deleteBeforeReplace should be properly set`() {
        runBlocking {
            // when
    ...
    @Test
    fun `option dependsOn should be properly set`() {
        runBlocking {
            // given
            val kotlinResource1 =
    ...
    @Test
    fun `option id should be properly set`() {
        runBlocking {
            // given
            val id = "id"
    ...
    @Test
    fun `option ignoreChanges should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `option importId should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `option replaceOnChanges should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `option resourceTransformations should be properly set`() {
        runBlocking {
            // given
    ...
    @Test
    fun `options should be properly merged to existing options`() {
        runBlocking {
            // given
    ...
    @Test
    fun `empty options should contain only nulls or type defaults`() {
        runBlocking {
            // when
            val opts = opts {
            }
