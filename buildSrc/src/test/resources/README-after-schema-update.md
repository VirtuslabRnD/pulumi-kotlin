...
```kt
implementation("org.virtuslab:pulumi-random-kotlin:4.8.1.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/random/4.8.1.0/index.html">link</a></td>
  </tr>
  <tr>
    <td>aws</td>
    <td>5.17.0.0-alpha.1665590627+9c01b95f</td>
    <td> 
...
<dependency>
     ...
     <version>5.17.0.0-alpha.1665590627+9c01b95f</version>
</dependency>
```
...
```kt
implementation("org.virtuslab:pulumi-aws-kotlin:5.17.0.0-alpha.1665590627+9c01b95f")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/aws/5.17.0.0-alpha.1665590627+9c01b95f/index.html">link</a></td>
  </tr>
  <tr>
    <td>gcp</td>
    <td>6.39.0.0</td>
...
```kt
implementation("org.virtuslab:pulumi-gcp-kotlin:6.39.0.0")
```
    ...
    <td><a href="https://storage.googleapis.com/pulumi-kotlin-docs/gcp/6.39.0.0/index.html">link</a></td>
  </tr>
</table>
